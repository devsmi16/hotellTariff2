...
public class Welcome {
    ...
    public static void main(String[] args) {
        ...
        HotelRoomService[][][] hrs = new HotelRoomService[30][5][5];
        Book[] b = new Book[30];
        ...
        for (i = 0; i < 30; i++) {
            for (j = 0; j < 5; j++) {
                for (k = 0; k < 5; k++) {
                    hrs[i][j][k] = new HotelRoomService();
                    l[i][j][k] = new Laundry();
                }
            }
        }
            ...
            if (ch == 'b') {
                for (i = 0; i < 3; i++) {
                    ...
                    for (i = 0; i < 8; i++) {
                        ...
                        b[ic].BookNew(c[ic], ly[ily], dx[idx], sdx[isdx], hrs, l, ily, flag1, idx, flag2, isdx, flag3);
                    ...
                    if (ch == 's') {
                        ...
                        if (a == 1) {
                            hrs[itr1][itr2][0].setDetails();
                            b[cno].s1 = b[cno].s1 + (hrs[itr1][itr2][0].getTotalCost());
